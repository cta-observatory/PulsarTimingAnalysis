...
# mail: alvmas@ucm.es
# Using modules from PINT-pulsar to calculate phases and add them to the input files.
###################3
...
def main():
    ...
    parser.add_argument(
        "--in_file", "-f", action="store", type=str, dest="in_file", default=None
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--ft2", "-ft2", action="store", type=str, dest="ft2_file", default=None
    )
