...
def interpolate_phase(timelist,timelist_sample,barycent_toas_sample,phase_sample):
    from scipy.interpolate import interp1d

    print('Interpolating...')
    interp_function_mjd = interp1d(timelist_sample, barycent_toas_sample)
    interp_function_phase=interp1d(timelist_sample, phase_sample)
