...
class PeakFitting():
        ...
        def fit_ULmodel(self,pulsar_phases):  
            ...
            if self.model=='dgaussian':
                unbinned_likelihood = cost.UnbinnedNLL(double_gaussian, np.array(shift_phases))
            ...
            if self.model=='tgaussian':
                unbinned_likelihood = cost.UnbinnedNLL(triple_gaussian, np.array(shift_phases))
                ...
                unbinned_likelihood = cost.UnbinnedNLL(assymetric_double_gaussian, np.array(shift_phases))
