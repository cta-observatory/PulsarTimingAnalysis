...
class Lightcurve():
    ...
    def draw_peakstats(self,pulsar_phases,phase_limits): 
        ...
        plt.annotate(text_towrite, xy=(0.25, 1.3), xytext=(0.25,1.3), fontsize=15,xycoords='axes fraction', textcoords='offset points', color='tab:red',bbox=dict(facecolor='white', edgecolor='tab:red'),horizontalalignment='left', verticalalignment='top')
